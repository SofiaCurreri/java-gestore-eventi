...
//        System.out.println(concerto.toString());
        ...
        //************************************PROGRAMMA EVENTI**********************************
        ProgrammaEventi eventi = new ProgrammaEventi("Summer Tour");
        eventi.aggiungiEvento(new Evento("Concerto Katy Perry", LocalDate.of(2023,11,29), 200));
        eventi.aggiungiEvento(new Evento("Breaking Italy live show", LocalDate.of(2024,2,12), 100));
        eventi.aggiungiEvento(new Evento("Concerto Russ", LocalDate.of(2023,11,29), 400));

        System.out.println("Numero eventi presenti in lista: " + eventi.numEventi());
        System.out.println("Eventi che avranno luogo il " + LocalDate.of(2023,11,29) + " : \n" + eventi.eventiFiltratiPerData(LocalDate.of(2023,11,29)));
        System.out.println("Programma eventi: ");
        eventi.programma();
        eventi.svuotaLista();
        System.out.println("Numero eventi dopo aver svuotato lista eventi: " + eventi.numEventi());
